...
public class Lobby implements ILobbyLoggedIn, ILobbyNotLoggedIn {
    ...
    //Inloggen
    @FXML
    TextField tfGebruikersnaam;
    @FXML
    TextField tfWachtwoord;
    @FXML
    Button btInloggen;
    @FXML
    Button btNieuwAccount;
    @FXML
    Button btAfsluiten;

    //Nieuw account
    @FXML
    TextField tfGebruikersnaamNieuw;
    @FXML
    TextField tfWachtwoordNieuw;
    @FXML
    TextField tfEmail;
    @FXML
    TextField tfHerhaalWachtwoordNieuw;
    @FXML
    Button btMaakAccountAan;
    ...
    public void tfWachtwoordKeyPressed(Event evt) {
    ...
    public void StartNieuw(Event evt) {
        Bot.nextBotNr = 0;
        Game game = new Game(this, user, "SingleFun");
        game.start();
