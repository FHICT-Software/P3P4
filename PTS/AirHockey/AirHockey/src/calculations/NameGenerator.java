...
/**
 * In this class you can find all properties and operations for NameGenerator. //CHECK
 *
...
* @param vocals
     ...
     * @param endConsonants
     * @param nameInstructions Use only the following letters: (v=vocal,c=startConsonsonant,d=endConsonants)! Pass something like
     *                         {"vd", "cvdvd", "cvd", "vdvd"}
     */
    public NameGenerator(String[] vocals, String[] startConsonants,
